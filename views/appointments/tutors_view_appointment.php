                ...
                <?php foreach ($appointments as $row): ?>
                    <div class="card">
                        <div class="card-header">
                            <p>Session with
                                <?php echo htmlspecialchars($row['student_first_name'] . ' ' . $row['student_last_name']); ?>
                            </p>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="card-action">
                                    ...
                                    <?php elseif ($row['status'] == 'pending'): ?>
                                        <button class="btn btn-success btn-sm me-2"
                                            onclick="updateStatus(<?php echo $row['appointment_id']; ?>, 'confirmed')">Accept</button>
                                        <button class="btn btn-danger btn-sm"
                                            onclick="updateStatus(<?php echo $row['appointment_id']; ?>, 'cancelled')">Decline</button>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
